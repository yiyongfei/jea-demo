package com.architecture.example.web.rest.impl;
...
@Controller("exampleREST")
public class ExampleRESTImpl extends AbstractController implements ExampleREST {
	...
	public void delete(String id) {
		try {
			this.dispatch(WebConstant.CALL_BACK.SYNC.getCode(), "exampleDeleteFacade", id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
